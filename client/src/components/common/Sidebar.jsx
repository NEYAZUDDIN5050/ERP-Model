...
const Sidebar = () => {
  return (
    <div className="bg-white text-black w-64 h-full pt-13 fixed">
      ...
      <ul className="mt-6">
        <li>
          <Link to="/" className="flex items-center p-1 hover:bg-gray-700">
            <FaHome className="mr-2" /> Home
          </Link>
        </li>
        <li>
          <Link to="/finance" className="flex items-center p-1 hover:bg-gray-700">
            <FaMoneyBillWave className="mr-2" /> Finance
          </Link>
        </li>
        <li>
          <Link to="/hr" className="flex items-center p-1 hover:bg-gray-700">
        ...
        <li>
          <Link to="/scm" className="flex items-center p-1 hover:bg-gray-700">
            <FaTruck className="mr-2" /> Supply Chain
          </Link>
        </li>
        <li>
          <Link to="/crm" className="flex items-center p-1 hover:bg-gray-700">
        ...
        <li>
          <Link to="/sales" className="flex items-center p-1 hover:bg-gray-700">
            <FaChartLine className="mr-2" /> Sales
          </Link>
        </li>
        <li>
          <Link to="/inventory" className="flex items-center p-1 hover:bg-gray-700 ">
